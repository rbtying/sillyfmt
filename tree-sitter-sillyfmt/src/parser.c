...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [36] = {
    ...
    [anon_sym_RBRACE] = ACTIONS(31),
    [anon_sym_COMMA] = ACTIONS(31),
    [aux_sym_text_token1] = ACTIONS(192),
    [sym_time] = ACTIONS(31),
  },
  [37] = {
  ...
  [38] = {
    ...
    [aux_sym_text_token1] = ACTIONS(200),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [171] = {.count = 1, .reusable = true}, REDUCE(aux_sym_comma_delimited_sequence_repeat1, 1),
  [173] = {.count = 1, .reusable = false}, REDUCE(sym__expression, 1),
  ...
  [182] = {.count = 1, .reusable = false}, REDUCE(aux_sym_comma_delimited_sequence_repeat1, 1),
  [184] = {.count = 1, .reusable = true}, REDUCE(sym_comma_delimited_sequence, 2),
  [186] = {.count = 1, .reusable = false}, REDUCE(sym_comma_delimited_sequence, 2),
  [188] = {.count = 1, .reusable = true}, REDUCE(sym_binary_op, 3),
  [190] = {.count = 1, .reusable = false}, REDUCE(sym_binary_op, 3),
  [192] = {.count = 1, .reusable = false}, REDUCE(sym_symbol, 1),
  [194] = {.count = 1, .reusable = true}, REDUCE(sym_text, 1),
  [196] = {.count = 1, .reusable = false}, REDUCE(sym_text, 1),
  [198] = {.count = 1, .reusable = true}, REDUCE(sym_container, 2, .production_id = 1),
  [200] = {.count = 1, .reusable = false}, REDUCE(sym_container, 2, .production_id = 1),
  [202] = {.count = 1, .reusable = true}, REDUCE(sym_container, 3, .production_id = 2),
  [204] = {.count = 1, .reusable = false}, REDUCE(sym_container, 3, .production_id = 2),
  [206] = {.count = 2, .reusable = true}, REDUCE(aux_sym_comma_delimited_sequence_repeat2, 2), SHIFT_REPEAT(27),
  [209] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
};
